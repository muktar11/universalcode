...
const SignupForm = () => {
  ...
  const handleSignup = async (user: z.infer<typeof SignupValidation>) => {
    try {
      ...
      await createUserAccount(createUser); // No need to assign to a variable
    
      // If createUserAccount completes without throwing an error, assume registration is successful
      toast({ title: "Registration Successful." });
      navigate("/");
    } catch (error) {
      // If createUserAccount throws an error, show an error message
      console.log({ error });
