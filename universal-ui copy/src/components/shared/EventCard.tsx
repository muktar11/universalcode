...
const EventCard = ({ event }: EventsCardProps) => {
            ...
            <img src={"/assets/icons/profile-placeholder.svg"} alt="creator" className="w-12 lg:h-12 rounded-full"/>
              ...
              <div className="flex-center gap-2 text-light-3">
                  ...
                  <div className="flex items-center gap-3">      
                    ...
                    <div className="flex items-center gap-3">      
                    <p className="subtle-semibold lg:small-regular">Course link {event.class_link}</p>
              
                    </div>

                    <div className="flex items-center gap-3">      
                    <p className="subtle-semibold lg:small-regular">Course password {event.class_password} </p>
