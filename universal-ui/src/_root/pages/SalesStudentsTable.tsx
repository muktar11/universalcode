...
import { useGetRecentSalesStudents } from "@/lib/react-query/queries";
...
export function SalesStudentsTable({}: PostFormProps) {
  const { isLoading, isError, data: staff } = useGetRecentSalesStudents();
  ...
  return (
    <div>
      <Card className="h-full w-full overflow-scroll bg-lightgray">
        <h2 className="h3-bold md:h2-bold text-left w-full">Registered Students</h2>
...
export default SalesStudentsTable;
